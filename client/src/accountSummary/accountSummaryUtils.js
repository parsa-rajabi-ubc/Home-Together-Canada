...
export const prepareBusinessAccountInfo = (business) => {
    return {
        ...
        mailingAddressLine1: resolveOptionalField(business.mailingAddressLine1),
        mailingAddressLine2: resolveOptionalField(business.mailingAddressLine2),
        mailingCity: resolveOptionalField(business.mailingCity),
        mailingPostalCode: resolveOptionalField(business.mailingPostalCode),
        mailingProvince: resolveOptionalField(business.mailingProvince),
