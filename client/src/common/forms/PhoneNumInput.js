        ...
        <div>
            <label className={labelClassName}>
                ...
                <input className={className} type="text" autoComplete="tel-area-code"
                       name="first" placeholder="222" value={value && value.first || undefined} onChange= {onChange} maxLength="3"/>
            </label>
            <label>
                <input className={className} type="text" autoComplete="tel-local-prefix"
                       name="middle" placeholder="333" value={value && value.middle || undefined} onChange= {onChange} maxLength="3"/>
            </label>
            <label>
                <input className={className} type="text" autoComplete="tel-local-suffix"
                       name="last" placeholder="4444" value={value && value.last || undefined} onChange= {onChange} maxLength="4"/>
            </label>
        </div>
    );
}
