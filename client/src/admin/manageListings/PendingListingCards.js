        ...
        (listing) =>
            <div className={"flex"} key={listing.id}>
                ...
                <section className={"my-8"}>
                    <button className={"focus:outline-none"} type="button" onClick={e => onClickDecision(true, listing.id) }>
                        <AiFillCheckCircle
                            className={"text-green-600 hover:text-green-700 hover:cursor-pointer align-top"}
                            size="40"
                        />
                    </button>
                    <button className={"focus:outline-none"} type="button" onClick={e => onClickDecision(false, listing.id)}>
                        <AiFillCloseCircle
