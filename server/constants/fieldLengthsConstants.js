 ...
 * @Created:    2021.05.24
 *
 * @Description: lengths for all fields that are mutable by the user
 *
 */

const DEFAULT_STRING_LENGTH = 255;

const ABSTRACT_USER_FIELD_LENGTHS = {
    USERNAME: 50,
...
const AREA_OF_INTEREST_FIELD_LENGTHS = {
    PROVINCE: 2,
    CITY: 60
};

const BUSINESS_FIELD_LENGTHS = {
    BUSINESS_NAME: 100,
...
module.exports = {
    ...
    AREA_OF_INTEREST_FIELD_LENGTHS,
    BUSINESS_FIELD_LENGTHS,
    LISTING_FIELD_LENGTHS,
